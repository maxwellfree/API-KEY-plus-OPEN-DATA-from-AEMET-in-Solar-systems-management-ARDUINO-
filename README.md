...
Antes de publicar el repositorio debe elegirse explícitamente una
licencia.

Para un proyecto abierto pueden considerarse, por ejemplo, MIT,
BSD-3-Clause o GPLv3, dependiendo de las condiciones de reutilización
que se deseen.

Hasta que exista un archivo `LICENSE`, no debe asumirse automáticamente
que el código puede reutilizarse sin restricciones.
